...
REPORT zcds_visitor.
CLASS lcl_qlast_table_visitor DEFINITION
...
CLASS lcl_qlast_table_visitor IMPLEMENTATION.
...
START-OF-SELECTION.
  ...
  DATA(r_table_vistor) = NEW lcl_qlast_table_visitor( ).
  ...
  TRY.
      ...
      r_table_vistor->set_parser_version( lcl_qlast_table_visitor=>co_parser_vers-_750 ).
  ...
  ast_tree->accept( r_table_vistor ).

  LOOP AT r_table_vistor->qlast_datasources ASSIGNING FIELD-SYMBOL(<parsed_table>).
